...
export default {
  ...
  data () {
    return {
      ...
      separator: 'cell',
      columns: [
        { name: 'id', align: 'center', label: 'ID', field: 'id', sortable: true, headerClasses: 'bg-primary text-white text-h5' },
        {
          name: 'nome',
          required: true,
          label: 'Nome',
        ...
        { name: 'valor', align: 'center', label: 'Valor', field: 'val', sortable: true, headerClasses: 'bg-primary text-white text-uppercase text-h5' },
        { name: 'tipo', align: 'center', label: 'Tipo', field: 'tipo', sortable: true, headerClasses: 'bg-primary text-white text-uppercase text-h5 ' },
